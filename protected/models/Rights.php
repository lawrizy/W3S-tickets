...
class Rights {
    ...
    //---------------------------- Getters & Setters ---------------------------
    //--------------------------------------------------------------------------
    public function setAdmin($droit) { $this->admin = $droit; }
    ...
    public function getTrad() { return $this->trad; }
