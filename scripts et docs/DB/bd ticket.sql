...
-- -----------------------------------------------------
-- Table `websystickets`.`w3sys_priorite`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `websystickets`.`w3sys_priorite` (
...
-- -----------------------------------------------------
-- Table `websystickets`.`w3sys_entreprise`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `websystickets`.`w3sys_entreprise` (
...
-- -----------------------------------------------------
-- Table `websystickets`.`w3sys_categorie_incident`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `websystickets`.`w3sys_categorie_incident` (
  ...
  INDEX `fk_w3sys_categorie_incident_w3sys_entreprise1_idx` (`fk_entreprise` ASC),
  CONSTRAINT `fk_w3sys_categorie_incident_w3sys_categorie_incident1`
    FOREIGN KEY (`fk_parent`)
    REFERENCES `websystickets`.`w3sys_categorie_incident` (`id_categorie_incident`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_w3sys_categorie_incident_w3sys_priorite1`
    FOREIGN KEY (`fk_priorite`)
    REFERENCES `websystickets`.`w3sys_priorite` (`id_priorite`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_w3sys_categorie_incident_w3sys_entreprise1`
    FOREIGN KEY (`fk_entreprise`)
    REFERENCES `websystickets`.`w3sys_entreprise` (`id_entreprise`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `websystickets`.`w3sys_statut_ticket`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `websystickets`.`w3sys_statut_ticket` (
...
-- -----------------------------------------------------
-- Table `websystickets`.`w3sys_fonction`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `websystickets`.`w3sys_fonction` (
...
-- -----------------------------------------------------
-- Table `websystickets`.`w3sys_langue`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `websystickets`.`w3sys_langue` (
...
-- -----------------------------------------------------
-- Table `websystickets`.`w3sys_user`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `websystickets`.`w3sys_user` (
  ...
  CONSTRAINT `fk_w3sys_user_w3sys_fonction1`
    ...
    REFERENCES `websystickets`.`w3sys_fonction` (`id_fonction`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_w3sys_user_w3sys_langue1`
    FOREIGN KEY (`fk_langue`)
    REFERENCES `websystickets`.`w3sys_langue` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `websystickets`.`w3sys_batiment`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `websystickets`.`w3sys_batiment` (
...
-- -----------------------------------------------------
-- Table `websystickets`.`w3sys_canal`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `websystickets`.`w3sys_canal` (
...
-- -----------------------------------------------------
-- Table `websystickets`.`w3sys_ticket`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `websystickets`.`w3sys_ticket` (
  ...
  CONSTRAINT `fk_w3sys_ticket_w3sys_statut_ticket1`
    ...
    REFERENCES `websystickets`.`w3sys_statut_ticket` (`id_statut_ticket`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  ...
  CONSTRAINT `fk_w3sys_ticket_w3sys_user1`
    FOREIGN KEY (`fk_user`)
    REFERENCES `websystickets`.`w3sys_user` (`id_user`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  ...
  CONSTRAINT `fk_w3sys_ticket_w3sys_batiment1`
    ...
    REFERENCES `websystickets`.`w3sys_batiment` (`id_batiment`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  ...
  CONSTRAINT `fk_w3sys_ticket_w3sys_canal1`
    ...
    REFERENCES `websystickets`.`w3sys_canal` (`id_canal`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `websystickets`.`w3sys_historique_ticket`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `websystickets`.`w3sys_historique_ticket` (
  ...
  CONSTRAINT `fk_w3sys_historique_ticket_w3sys_ticket`
    ...
    REFERENCES `websystickets`.`w3sys_ticket` (`id_ticket`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `websystickets`.`w3sys_lieu`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `websystickets`.`w3sys_lieu` (
...
-- -----------------------------------------------------
-- Table `websystickets`.`w3sys_trad`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `websystickets`.`w3sys_trad` (
  `id` INT(10) NOT NULL AUTO_INCREMENT,
  `fr` VARCHAR(128) NULL,
  `en` VARCHAR(128) NULL,
  `nl` VARCHAR(128) NULL,
...
-- -----------------------------------------------------
-- Table `websystickets`.`yiisession`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `websystickets`.`yiisession` (
  `id` CHAR(32) NOT NULL,
...
-- -----------------------------------------------------
-- Table `websystickets`.`w3sys_session`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `websystickets`.`w3sys_session` (
  ...
  CONSTRAINT `fk_w3sys_session_yiisession1`
    ...
    REFERENCES `websystickets`.`yiisession` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `websystickets`.`w3sys_controleur`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `websystickets`.`w3sys_controleur` (
...
-- -----------------------------------------------------
-- Table `websystickets`.`w3sys_droit`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `websystickets`.`w3sys_droit` (
  ...
  CONSTRAINT `fk_w3sys_droit_w3sys_controleur1`
    ...
    REFERENCES `websystickets`.`w3sys_controleur` (`id_controleur`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
